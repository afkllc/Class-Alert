...
8. Build with npx web-ext build --overwrite-dest --ignore-files "docs/**" "tests/**" ".superpowers/**" "icon-source.png".
9. Inspect ZIP manifest: ID must be class-alert@afkllc, version must be 1.0.
